...
public class starter extends android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "megaelektronik.expander_google", "megaelektronik.expander_google.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "megaelektronik.expander_google.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public megaelektronik.expander_google.main _main = null;
